...
const device_title = "3D printer";  // This is how the device will be called in error/warning/console messages
...
function io_exec(thisOrder, this_deviceID) {
    ...
    try {
        ...
        let path = `${shared.app_path}\\orders\\${device.type} ${device.id}\\${thisOrder.order_name}.gcode`;
